      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* Laravel icon SVG */}
              <svg className="text-4xl md:text-5xl text-red-500 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* PHP icon SVG */}
              <svg className="text-4xl md:text-5xl text-indigo-400 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* MySQL dolphin SVG */}
              <svg className="text-4xl md:text-5xl text-teal-400 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* Bootstrap icon SVG */}
              <svg className="text-4xl md:text-5xl text-purple-500 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* Postman icon SVG */}
              <svg className="text-4xl md:text-5xl text-orange-400 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
          ...
          >
            <div className="flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-white/10">
              {/* GitHub icon SVG */}
              <svg className="text-4xl md:text-5xl text-gray-300 transition-all duration-300 group-hover:scale-110" viewBox="0 0 64 64" fill="currentColor">
